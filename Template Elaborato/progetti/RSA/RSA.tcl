# 
# Project automation script for RSA 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source RSA.tcl), then you can
...
proc add_source_files {} {
   ...
   xfile add "Booth_multiplier.vhd"
   xfile add "Serial_Booth_PC_Moore.vhd"
   xfile add "add_sub.vhd"
   xfile add "boundary_scan_chain.vhd"
   xfile add "contatore_modulo_4.vhd"
   xfile add "edge_triggered_d_n.vhd"
   xfile add "full_adder.vhd"
   xfile add "funzione_hash_moltiplicazione.vhd"
   xfile add "funzione_hash_moltiplicazione_testbench.vhd"
   xfile add "generazione_valori_RSA.vhd"
   xfile add "gestore_RSA.vhd"
   xfile add "half_adder.vhd"
   xfile add "ipcore_dir/mem.xco"
   xfile add "latch_d.vhd"
   xfile add "mathpack.vhd"
   xfile add "montgomer_multiplier_2.vhd"
   xfile add "montgomery_multiplier.vhd"
   xfile add "montgomery_multiplier_TB.vhd"
   xfile add "mux2_1.vhd"
   xfile add "ripple_carry_adder.vhd"
   xfile add "shifter_a_sinistra.vhd"
   xfile add "test_module.vhd"
   puts ""
   puts "WARNING: project contains IP cores, synthesis will fail if any of the cores require regenerating."
   puts ""

   # Set the Top Module as well...
   project set top "Behavioral" "funzione_hash_moltiplicazione"
...
proc set_process_props {} {
   ...
   project set "Last Applied Goal" "Minimum Runtime"
   project set "Last Applied Strategy" "Runtime Strategy 1;/opt/Xilinx/14.7/ISE_DS/ISE/spartan3e/data/spartan3e_runtime.xds"
   ...
   project set "User Browsed Strategy Files" "/opt/Xilinx/14.7/ISE_DS/ISE/spartan3e/data/spartan3e_runtime.xds"
   ...
   project set "Placer Effort Level (Overrides Overall Level)" "Standard" -process "Place & Route"
   project set "Router Effort Level (Overrides Overall Level)" "Standard" -process "Place & Route"
   ...
   project set "Work Directory" "/media/sf_ASE/VHDL/Milo/RSA/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "funzione_hash_moltiplicazione" -process "Generate IBIS Model"
