...
-- \   \   \/     Version: P.20131013
--  \   \         Application: netgen
--  /   /         Filename: flipflop_rs_ms_timesim.vhd
-- /___/   /\     Timestamp: Wed Jan 10 01:00:27 2018
-- \   \  /  \ 
--  \___\/\___\
--             
-- Command	: -intstyle ise -s 5 -pcf flipflop_rs_ms.pcf -rpw 100 -tpw 0 -ar Structure -tm flipflop_rs_ms -insert_pp_buffers true -w -dir netgen/par -ofmt vhdl -sim flipflop_rs_ms.ncd flipflop_rs_ms_timesim.vhd 
-- Device	: 3s100etq144-5 (PRODUCTION 1.27 2013-10-13)
-- Input file	: flipflop_rs_ms.ncd
-- Output file	: C:\DAVIDE\ASE\Esercizi\ISE\latch_flip-flop\flipflop_rs_ms\netgen\par\flipflop_rs_ms_timesim.vhd
-- # of Entities	: 1
...
begin
  ...
  Inst_rs_latch_clocked_slave_Inst_rs_latch_Inst_nor_gate1_f1 : X_LUT4
    ...
    port map (
      ...
      ADR1 => VCC,
      ADR2 => clock_IBUF_27,
      ADR3 => Inst_rs_latch_clocked_master_Inst_rs_latch_Inst_nor_gate2_f_or0000,
      O => q_OBUF_pack_3
    );
